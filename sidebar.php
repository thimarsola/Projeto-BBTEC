...
<!-- highlight -->
<div class="blog__row__sidebar__highlight p-4 bg-light-gray-500 radius mb-7">
...
<!-- categories -->
<div class="blog__row__sidebar__categories p-4 bg-light-gray-500 radius mb-7">
    <!-- header -->
...
<!-- social -->
<div class="blog__row__sidebar__social p-4 bg-light-gray-500 radius">
    <!-- header -->
